  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 El arte de los videojuegos
        p.mb-4 Reconocer los principios básicos que se deben tener en cuenta para la creación de videojuegos como herramienta para un mejor aprendizaje.
